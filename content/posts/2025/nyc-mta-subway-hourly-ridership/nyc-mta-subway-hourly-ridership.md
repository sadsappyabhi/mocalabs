...
Recently, I created some visualizations in Tableau to explore a dataset that is personally interesting to me. I am passionate about public transit and walkable cities, and will be forever disappointed that pretty much all of North America besides NYC allowed car dependency to destroy our cities during the mid 20th century. If the previous sentence is surprising to you, [Jason Slaughter](https://en.wikipedia.org/wiki/Not_Just_Bikes) has a series of video essays that are a great introduction on the subject.
...
Fair warning/disclaimer: This was part of a project for school and the writing below was directed by the assignment guidelines. If you'd rather just see the Tableau Story it's available on [Tableau Public](https://public.tableau.com/app/profile/abhilasha.figueroa/viz/MTASubwayHourlyRidershipSince2022/PresentationSlides). 
...
![Heat Map of Hourly Transit Entrances by Borough](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q1%20HeatMap%20Formatted.png)

The highest concentration of rider entrances occurs in Manhattan during the afternoon. This supports the hypothesis that:
...
![Line Graph of Hourly Transit Entrances by Borough](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q1%20Line%20Graph%20Formatted.png)

In the above line graph, the distribution between each borough can be seen more clearly. An interesting pattern emerges when we compare each borough’s high point: Brooklyn, Queens, and the Bronx all have their peaks during the morning rush hour. This suggests that most rush hour traffic flows from these boroughs into Manhattan in the morning, and then in the afternoon all these same people depart from Manhattan heading back to their borough of residence. 

![Tree Map of Hourly Transit Entrances by Borough](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q1%20Tree%20Map%20Formatted.png)
...
![Bar Chart of Payment Method by Hour](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q2%20Hourly%20Formatted.png)
...
![Bar Chart of Payment Method by Day of the Week](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q2%20DoW%20Formatted.png)
...
![Bar Chart of Payment Method by Borough](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q2%20Borough%20Formatted.png)
...
![Sorted Bar Chart of Busiest Stations](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q3%20Sorted%20Bar%20Formatted.png)
...
![Map of Top 10 Busiest Stations](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q3%20Map%20Formatted.png)
...
![Line Graph of Top 10 Busiest Stations by Hour with 47th-50th St-Rockefeller Center Station highlighted](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q3%20Hourly%20Formatted.png)
...
![Sorted Bar Chart of Top 10 Transfer Stations](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q4%20Sorted%20Bar%20Formatted.png)
...
![Line Graph of Hourly Transfers by Borough](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q4%20Hourly%20Line%20Formatted.png)
...
![Map of Top 10 Transfer Stations](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q4%20Map%20Formatted.png)
...
![Line Graph of Hourly Ridership of 30-Day and 7-Day Passes](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q5%20Hourly%20Formatted.png)
...
![Bar Chart of 30-Day and 7-Day Pass Ridership by Borough](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q5%20Borough%20Formatted.png)
...
![Bar Chart of 30-Day and 7-Day Passes at the Top 20 Stations](/posts/2025/nyc-mta-subway-hourly-ridership/img/Q5%20Busiest%20Stations%20Formatted.png)
