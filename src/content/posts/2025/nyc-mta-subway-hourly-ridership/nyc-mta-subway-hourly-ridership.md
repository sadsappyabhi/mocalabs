...
description: "A data analytics and visualization project exploring NYC MTA Subway Ridership patterns"
---
...
![NYC MTA Hourly Ridership Since 2022 Cover Image](./img/Story%20Title%20Page.png)
...
![Dashboard containing a Heat Map, Line Graph, and a Tree Map of hourly ridership by borough](./img/Q1%20Dashboard.png)
...
![Dashboard containing bar charts of OMNY and MetroCard users by hour of the day, day of the week, and borough](./img/Q2%20Dashboard.png)
...
![Dashboard containing a bar chart, map, and  line graph of the top 10 busiest subway stations](./img/Q3%20Dashboard.png)
...
![Dashboard containing a bar chart, line chart, and a map of the top 10 transfer stations](./img/Q4%20Dashboard.png)
...
![Dashboard containing a comparison between MetroCard Unlimited 7-Day and 30-Day passes](./img/Q5%20Dashboard.png)
...
![Thank You Slide](./img/Story%20Ending%20Page.png)

There you have it! This was certainly a fun dataset to work with. I now welcome your comments and hatemail &mdash; you can find both my email and Mastodon on the contact page of my [artist website](https://www.abhiche.com/).
